...
<div class="bg-beige text-bleu text-body sm:text-body_mobile">
    ...
    <div class="sm:mx-[4vw] md:mx-[10vw] mx-[8vw] mt-10">
        ...
        <div class="flex relative mb-20 flex-wrap gap-10 justify-center">
            ...
            <?php if (have_posts()) : ?>
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    $date = get_field('date');
                    if ($type === "Article de presse d'un autre site") : ?>

                        <a href="<?php echo esc_url(get_post_meta(get_the_ID(), 'lien', true)); ?>" target="_blank">
                            <div class="w-80 bg-rose text-noir py-3 px-5">
                                ...
                                <div class="flex items-center justify-between mb-5">
                                    ...
                                    <div class="w-5"><?php echo wp_get_attachment_image(82, array(400, 400)); ?></div>
                                </div>
