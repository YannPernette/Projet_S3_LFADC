    ...
    <div class='sm:mx-[4vw] md:mx-[10vw] mx-[20vw] mt-10'>
        ...
        <div class='bg-blanc mb-10 p-4 md:px-3 lg:px-14 px-32 rounded-lg shadow-md'>
            ...
            <form class="font-montserrat" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post">
                ...
                <div class='flex my-4'><input class='self-start mr-1' type="checkbox" name="MentionLegal" value="" required><label for="MentionLegal">En envoyant ce formulaire, j'accepte que les informations saisies soient utilisées aux fins de traitement ou de prise de contact avec la personne concernée. Il n’y a pas de transfert de ces données personnelles à des tiers.</label></div>
